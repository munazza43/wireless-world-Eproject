...
function item1(a)
{
  var select2 = document.getElementById("select2").value;
    if(a != select2)
    {
     ...
     document.getElementById('ram1').innerHTML = products[a].ram
     document.getElementById('rom1').innerHTML = products[a].rom
        ...
        document.getElementById('ram1').innerHTML = "N/A"
        document.getElementById('rom1').innerHTML = "N/A"
    }
}
function item2(b)
{
  var select1 = document.getElementById("select1").value;
    if(b != select1)
    {
     ...
     document.getElementById('ram2').innerHTML = products[b].ram
     document.getElementById('rom2').innerHTML = products[b].rom
    }
    else{
